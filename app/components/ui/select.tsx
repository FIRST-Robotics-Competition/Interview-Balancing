  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        shadow-xs flex w-fit items-center justify-between gap-2
        whitespace-nowrap rounded-md border bg-transparent px-3 py-2 text-sm
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          origin-(--radix-select-content-transform-origin) relative z-50
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2
        ...
        rounded-sm py-1.5 pl-2 pr-8 text-sm data-[disabled]:pointer-events-none
